...
#' Funcao para realizar rodadas encadeadas considerando etp variavel do SMAP/ONS
#' 
#' Realiza execucoes encadeadas do modelo SMAP/ONS considerando etp variavel e
#' aprimoramentos do Rsolo
#'
#' @param parametros data table com os parametros dos modelos
#'     \itemize{
#'     \item{nome - nome da sub-bacia}
...
#'     }
#' @export
rodada_encadeada_pmur_etp <- function(parametros, inicializacao, precipitacao_observada, 
    precipitacao_prevista, evapotranspiracao_observada, evapotranspiracao_prevista, vazao_observada, 
    postos_plu, datas_rodadas, sub_bacias) {
    ...
    for (ibacia in 1:numero_sub_bacias){
        ...
        for (idata in 1:numero_datas){
            ...
            simulacao <- simulacao <- funcaoSmapCpp::rodada_pmur_cpp_cenario(as.numeric(c(vetor_modelo[1:11], vetor_modelo[75:78])),
            vetor_inicializacao, area, matriz_precipitacao,
            matriz_evapotranspiracao, matriz_evapotranspiracao_planicie, (numero_dias_previsao + numero_dias_assimilacao), numero_cenarios)
...
#' }
#' @export
rodada_encadeada_pmur <- function(parametros, inicializacao, precipitacao_observada, 
    precipitacao_prevista, evapotranspiracao_nc, vazao_observada, postos_plu, datas_rodadas, 
    sub_bacias) {
    ...
    for (ibacia in 1:numero_sub_bacias){
        ...
        for (idata in 1:numero_datas){
            ...
            simulacao <- funcaoSmapCpp::rodada_pmur_cpp_cenario(as.numeric(c(vetor_modelo[1:11], vetor_modelo[75:78])),
            vetor_inicializacao, area, matriz_precipitacao,
            matriz_evapotranspiracao, matriz_evapotranspiracao_planicie, (numero_dias_previsao + numero_dias_assimilacao), numero_cenarios)
...
#' 
#' Realiza execucoes encadeadas do modelo SMAP/ONS considerando etp variavel
#' aprimoramento Rsolo, sem assimilar ETP
#'
#' @param parametros data table com os parametros dos modelos
#'     \itemize{
#'     \item{nome - nome da sub-bacia}
...
#'     }
#' @export
rodada_encadeada_pmur_nAssimilaEtp <- function(parametros, inicializacao, precipitacao_observada, 
    precipitacao_prevista, evapotranspiracao_observada, evapotranspiracao_prevista, vazao_observada, 
    postos_plu, datas_rodadas, sub_bacias) {
